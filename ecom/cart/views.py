...
def cart_add(request):
    ...
    if request.POST.get('action') == 'post':
        ...
        messages.success(request, ("Product added to cart, Chief!"))
        return response 
...
def cart_update(request):
    ...
    if request.POST.get('action') == 'post':
        ...
        messages.success(request, ("Quantity updated, Chief!"))
        return response
...
def cart_delete(request):
    ...
    if request.POST.get('action') == 'post':
        ...
        messages.success(request, ("Item deleted from cart, Chief!"))
        return response